...
class DiaryCategoryManagementPage extends StatefulWidget {
  final TagManager tagManager;

  const DiaryCategoryManagementPage({
    super.key,
    required this.tagManager,
  });

  @override
  State<DiaryCategoryManagementPage> createState() => _DiaryCategoryManagementPageState();
}

class _DiaryCategoryManagementPageState extends State<DiaryCategoryManagementPage> {
